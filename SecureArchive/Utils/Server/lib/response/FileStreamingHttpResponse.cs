...
public class FileStreamingHttpResponse : FileHttpResponse {
    public long Start { get; set; } = 0;
    public long End { get; set; } = 0;

    public FileStreamingHttpResponse(HttpRequest req, string contentType, string filePath, long start, long end)
        : base(req, HttpStatusCode.Ok, contentType, filePath) {
        Start = start;
        End = end;
    }
